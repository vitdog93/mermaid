function addItem() {
    $("#formItem").attr('action', '/connect/shipping/insurance/create');
...
function editItem(id) {
    ...
    $.ajax({
        type: 'GET',
        url: '/connect/shipping/insurance/detail/' + id,
        success: function (res) {
            $("#formItem").attr('action', '/connect/shipping/insurance/update/' + id);
...
$('#modalItem').on('hidden.bs.modal', function () {
    $("#formItem").attr('action', '/connect/shipping/insurance/create').trigger('reset');
});
