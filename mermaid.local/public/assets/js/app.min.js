...
$(window).on("load", function () {
    ...
    if ($("#data-table")[0]) {
        ...
        ], language: {searchPlaceholder: "Search for records..."}, sDom: '<"dataTables__top"lfB>rt<"dataTables__bottom"ip><"clear">', buttons: [
    ...
    if ($(".color-picker")[0] && ($(".color-picker").each(function () {
        ...
        $(".widget-calendar__body").fullCalendar({contentHeight: "auto", theme: !1, buttonIcons: {prev: " zmdi zmdi-long-arrow-left", next: " zmdi zmdi-long-arrow-right"}, header: {right: "next", center: "title, ", left: "prev"}, defaultDate: "2016-08-12", editable: !0, events: [
